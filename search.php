...
$sql = "SELECT id, nazwa, wlasciciel_imie, wlasciciel_nazwisko, opis, NIP, logo_link, strona, tel FROM firmy WHERE 
nazwa LIKE '%$szukaj%' OR 
wlasciciel_imie LIKE '%$szukaj%' OR 
wlasciciel_nazwisko LIKE '%$szukaj%' OR 
opis LIKE '%$szukaj%' OR 
NIP LIKE '%$szukaj%' OR 
strona LIKE '%$szukaj%' OR 
tel LIKE '%$szukaj%' 
ORDER BY nazwa";
